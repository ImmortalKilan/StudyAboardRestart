...
const PURPLE_TRIGGERS = [
  ...
  { relicName: '扑克牌', storylines: ['poker', 'triton', 'local_shark'], boostStat: 'POK', boostAmount: 6, log: '你拿起那副51张的牌，第一手就是同花顺。' },
  ...
  { relicName: '夜行手套', storylines: ['thief'], boostStat: 'PER', boostAmount: 3, log: '戴上手套的瞬间，黑暗变得透明。' },
  { relicName: '断裂的魔杖', storylines: ['hogwarts'], boostStat: 'MAG', boostAmount: 5, log: '魔杖断口处迸出火花，它认出了你。' },
  { relicName: '停摆的怀表', storylines: ['timeloop'], boostStat: 'PER', boostAmount: 4, log: '怀表突然开始走动，你感觉时间在你手中。' },
  { relicName: '锈迹斑斑的哑铃', storylines: ['fitness'], boostStat: 'FIT', boostAmount: 5, log: '举起哑铃的那一刻，前世的肌肉记忆全部回来了。' },
  { relicName: '破碎的手机屏', storylines: ['influencer', 'mcn', 'streamer'], boostStat: 'FAN', boostAmount: 10, log: '碎屏亮起，粉丝数从0开始疯涨。' },
